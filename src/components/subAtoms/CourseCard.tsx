    ...
    <div className="relative flex flex-col p-4 rounded-sm shadow-lg bg-white mx-4 flex-shrink-0 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <div className="flex-shrink-0 pr-4">
          <button className="px-4 py-2  rounded border-2 border-solid border-purple-400  flex justify-center items-center gap-2.5 text-purple-600 font-roboto font-normal text-center   ">
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <div className="flex-shrink-0 pl-2">
          <Link href={link} target='_blank'>
            <button className="px-28 py-2 rounded border shadow-md border-solid border-purple-500 font-roboto font-medium bg-purple-500 text-white transition-colors duration-300 hover:bg-purple-600 hover:text-white">
              Buy Now
            </button>
          </Link>
        </div>
